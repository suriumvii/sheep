...
function mapfunc(data) {
	...
	function mapFormatting(feature,layer) {
		switch(feature.geometry.type.toLowerCase()) {
			case 'point':
				layer.bindPopup('<table class="table table-sm"><thead><tr><th colspan="2" class="bg-success" style="text-align:center;">'+ 
				feature.properties.areainfo +'</th></tr></thead><tbody><tr><th scope="row">Total Lot Area</th><td>'+ 
				feature.properties.totallotarea +'</td></tr></tbody></table>')
				.on('click', itemClick)
			...
			case 'polygon':
				...
				feature.properties.owner +'</td></tr><tr><th scope="row">Lot Area</th><td>'+ 
